	...
	void emit(particle_emitter_instance *pe_inst, int elapsedtime)
	{
		...
		if (particlestoemit > 0)
		{
			...
			for (int i = 0; i < 10; i++)
			{
				...
				p_inst->o.x = pe_inst->o.x + (i * pe_inst->density / 2);
				...
				p_inst->vel.z = pe_inst->vel.z + pe_inst->vel.z * sin(ps.particlemillis / 1000.0);
				...
				if (i > 0)
				{
					...
					spring_inst1->spring_constant = 0.08f;
					spring_inst1->spring_friction = 0.10f;
				...
				if (previous.size() > i)
				{
					...
					spring_inst2->spring_constant = 0.08f;
					spring_inst2->spring_friction = 0.10f;
					...
					if (i > 0)
					{
						...
						spring_inst3->spring_constant = 0.08f;
						spring_inst3->spring_friction = 0.10f;
					...
					if (i < 9)
					{
						...
						spring_inst4->spring_constant = 0.08f;
						spring_inst4->spring_friction = 0.10f;
