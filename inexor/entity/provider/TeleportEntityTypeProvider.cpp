/*
 * TeleportEntityTypeProvider.cpp
 *
...
namespace entity {
    ...
    TeleportEntityTypeProvider::TeleportEntityTypeProvider() : EntityTypeProvider(ENT_TELEPORT)
    {
    ...
    TeledestEntityTypeProvider::TeledestEntityTypeProvider() : EntityTypeProvider(ENT_TELEDEST)
    {
        ...
        : RelationshipTypeProvider(REL_TELEPORTING, entity_type_manager)
    {
        ...
        relationship_type = new RelationshipType(REL_TELEPORTING,
                                                 true,
                                                 true,
