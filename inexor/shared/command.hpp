...
#define _SVARF(name, global, cur, body, persist) void var_##name(); SharedVar<char*> global; UNUSED char* dummy_register_##global = *global = (char*)svariable(#name, cur, &global, var_##name, persist); void var_##name() { body; }
