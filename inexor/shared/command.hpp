...
#define _VAR(name, global, min, cur, max, persist) SharedVar<int> global = reflection_marker((int)cur); UNUSED int dummy_register_##global = variable(#name, min, cur, max, &global, NULL, persist)
...
#define _VARF(name, global, min, cur, max, body, persist)  void var_##name(); SharedVar<int> global = reflection_marker((int)cur); UNUSED int dummy_register_##global = variable(#name, min, cur, max, &global, var_##name, persist); void var_##name() { body; }
...
#define _HVAR(name, global, min, cur, max, persist) SharedVar<int> global = reflection_marker(cur); UNUSED int dummy_register_##global = variable(#name, min, cur, max, &global, NULL, persist | IDF_HEX)
...
#define _HVARF(name, global, min, cur, max, body, persist)  void var_##name(); SharedVar<int> global = reflection_marker((int)cur); UNUSED int dummy_register_##global = variable(#name, min, cur, max, &global, var_##name, persist | IDF_HEX); void var_##name() { body; }
...
#define _FVAR(name, global, min, cur, max, persist) SharedVar<float> global = reflection_marker((float)cur); UNUSED float dummy_register_##global = fvariable(#name, min, cur, max, &global, NULL, persist)
...
#define _FVARF(name, global, min, cur, max, body, persist) void var_##name(); SharedVar<float> global = reflection_marker((float)cur); UNUSED float dummy_register_##global = fvariable(#name, min, cur, max, &global, var_##name, persist); void var_##name() { body; }
...
#define _SVAR(name, global, cur, persist) SharedVar<char*> global = reflection_marker((char *)cur); UNUSED char* dummy_register_##global = *global = (char*)svariable(#name, cur, &global, NULL, persist)
...
#define _SVARF(name, global, cur, body, persist) void var_##name(); SharedVar<char*> global = reflection_marker((char*)cur); UNUSED char* dummy_register_##global = *global = (char*)svariable(#name, cur, &global, var_##name, persist); void var_##name() { body; }
