...
int getWindowsKeyCode(SDL_Keysym const &key)
{
    ...
    case SDLK_0:
        result = alt_gr ? 64 : uppercase ? 48 : 224; // @ ? 0 : �
        break;
    case SDLK_1:
        result = uppercase ? 49 : 38; // 1 : & (KO)
        break;
    case SDLK_2:
        result = alt_gr ? 126 : uppercase ? 50 : 233; // ~ ? 2 : �
        break;
    case SDLK_3:
    ...
    case SDLK_6:
        ...
        break;
    case SDLK_7:
        result = alt_gr ? 96 : uppercase ? 55 : 232; // ` ? 7 : �
        break;
    case SDLK_8:
        result = alt_gr ? 92 : uppercase ? 56 : 95; // \ ? 8 : _
        break;
    case SDLK_9:
        result = alt_gr ? 94 : uppercase ? 57 : 231; // ^ ? 9 : �
        break;
