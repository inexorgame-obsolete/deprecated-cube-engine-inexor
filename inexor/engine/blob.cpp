...
#include "inexor/engine/rendergl.hpp"                 // for glversion, disa...
...
struct blobrenderer
{
    ...
    void flushblobs()
    {
        ...
        glDrawRangeElements_(GL_TRIANGLES, 0, numvdata-1, numedata, GL_UNSIGNED_SHORT, (ushort *)nullptr);
    }
};
