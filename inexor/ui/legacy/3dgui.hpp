...
struct g3d_gui
{
    ...
    int textf(const char *fmt, int color, const char *icon = nullptr, ...) PRINTFARGS(2, 5)
    {
    ...
    int buttonf(const char *fmt, int color, const char *icon = nullptr, ...) PRINTFARGS(2, 5)
    {
        defvformatstring(str, icon, fmt);
        return button(str, color, icon);
    }
    virtual int title(const char *text, int color, const char *icon = nullptr) = 0;
    int titlef(const char *fmt, int color, const char *icon = nullptr, ...) PRINTFARGS(2, 5)
    {
        defvformatstring(str, icon, fmt);
