...
ShTreeNode::ShTreeNode(const std::string &full_cpp_type_dcl, const std::string &full_cpp_name, const std::string &var_namespace_,
                       const std::string &default_val, std::vector<attached_so> &so_constructor_arguments)
                          : name_cpp_short(full_cpp_name), var_namespace(var_namespace_),
