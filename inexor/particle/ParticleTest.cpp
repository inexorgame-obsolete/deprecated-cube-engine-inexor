...
namespace particle {
    ...
    void ParticleTest::ShowCase()
    {
        ...
        */
        ...
        billboard_renderer_1 = particle_subsystem->CreateRendererInstance(billboard_renderer_type, "particlepoints", "particle/ball1.png", 40.0f);
        ...
        rel_point_emitter_billboard_renderer_1 = particle_subsystem->AddRendererToEmitter(point_emitter_1, billboard_renderer_1);
        // rel_point_emitter_model_renderer_2 = particle_subsystem->AddRendererToEmitter(point_emitter_1, model_renderer_1);
