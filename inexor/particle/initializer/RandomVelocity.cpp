...
namespace particle {
    ...
    AttributeRefPtr RandomVelocity::Execute(TimeStep time_step, std::shared_ptr<EntityInstance> emitter_inst, std::shared_ptr<EntityInstance> initializer_inst, std::shared_ptr<EntityInstance> particle_inst)
    {
