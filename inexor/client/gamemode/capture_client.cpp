...
void captureclientmode::rendergame()
{
    ...
    void captureclientmode::replenishammo() {
    ...
    void captureclientmode::receiveammo(fpsent *d, int type) {
        type += I_SHELLS-1;
    ...
    void captureclientmode::rendertether(fpsent *d) {
    ...
    void captureclientmode::preload() {
    ...
    void captureclientmode::senditems(packetbuf &p) {
        putint(p, N_BASES);
    ...
    void captureclientmode::setscore(int base, const char *team, int total) {
    ...
    int captureclientmode::closesttoenemy(const char *team, bool noattacked, bool farthest) {
    ...
    int captureclientmode::pickteamspawn(const char *team) {
    ...
    void captureclientmode::aifind(fpsent *d, ai::aistate &b, vector<ai::interest> &interests) {
        vec pos = d->feetpos();
        loopvj(bases)
        {
            baseinfo &f = bases[j];
    ...
    bool captureclientmode::aidefend(fpsent *d, ai::aistate &b) {
    ...
    bool captureclientmode::parse_network_message(int type, ucharbuf &p) {
